...
<div class="container-fluid">
  <div class="row">
  <div class="col-xs-12">
  <p><b>The Data Viewer may take dozens of seconds to load due to the substantial volume of data present in the Developmental Lung Cell Atlas.</p>
  ...
  <iframe src="https://singlecellvis.app.bio-it.tech/#/?project=project_HDLCA" class="rounded-iframe" width="100%" height="1200" frameborder="0"></iframe>
  </div>
  </div>
</div>
